...
import com.google.android.gms.fitness.data.DataType
 ...
 val fitnessOption = FitnessOptions.builder()
  ...
  .addDataType(AGGREGATE_STEP_COUNT_DELTA, FitnessOptions.ACCESS_WRITE)
  ...
  .addDataType(AGGREGATE_CALORIES_EXPENDED, FitnessOptions.ACCESS_WRITE)
  .addDataType(TYPE_DISTANCE_DELTA, FitnessOptions.ACCESS_READ)
  .addDataType(TYPE_DISTANCE_DELTA, FitnessOptions.ACCESS_WRITE)
  .addDataType(AGGREGATE_DISTANCE_DELTA, FitnessOptions.ACCESS_READ)
  .addDataType(AGGREGATE_DISTANCE_DELTA, FitnessOptions.ACCESS_WRITE)
  .build()